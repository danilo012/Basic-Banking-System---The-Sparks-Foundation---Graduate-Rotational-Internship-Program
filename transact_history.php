...
<head>
    ...
    <title>JK Bank | Transaction History</title>
    <!--Google Fonts-->
...
<body>
    ...
    <header>
    	<div class="container">
        	<nav>
            	<div class="nav-brand">
                	<a href="index.php">
                    	<img src="images/logo.png" alt="JK Bank Logo">
                    </a>
                </div>
	...
	<footer>
    	...
    	<p>JK BANK - Built by <a href="https://www.linkedin.com/in/jeevankarthick-b/" target="_blank">Jeevankarthick B</a></p>
